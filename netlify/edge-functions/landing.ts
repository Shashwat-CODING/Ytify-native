  ...
  const html = `
    <div align="center">
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 0 20px;">
        <h2 style="margin-bottom: 1.2rem;">Welcome to ytify native</h2>
        <p style="font-size: 1.1rem; line-height: 1.5; margin-bottom: 2rem;">
          A resource-efficient audio streaming client for YouTube & YTMusic.
          <a style="text-decoration:underline; display: inline-block; margin-top: 0.8rem;" target="_blank" href="https://github.com/n-ce/ytify/wiki/usage">
            Learn more about how to use the application effectively
          </a>
        </p>
        
        ${cgeo === 'IN' ?
          `<div style="margin-top: 3rem; padding: 1.2rem; border-radius: 8px; background: rgba(0,0,0,0.05);">
             <img width="100" style="margin-bottom: 0.8rem;" src="https://upload.wikimedia.org/wikipedia/commons/6/6f/UPI_logo.svg" />
          ...
          `<div style="margin-top: 3rem;">
             <a style='text-decoration: underline; font-size: 0.95rem;' href='https://en.m.wikipedia.org/wiki/Individual_action_on_climate_change' target='_blank'>
               Keeping our consumptions low is the only way to retain our planet's ability to host mankind.
             </a>
           </div>`
        }
      </div>
